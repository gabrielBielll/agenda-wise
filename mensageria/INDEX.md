...
| `fase-1-front` | [0148](0148-duna-para-orla-e-vale-ci-do-desconectar.md) | 🔄 Desconexão por psicóloga publicada. CI: front completo e backend/uberjar/smoke verdes; navegador falhou ao inicializar container antes do checkout, portanto não votou | **vale** (revisar) · **orla** (CI do navegador) |
