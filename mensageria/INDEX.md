...
| `aud001-acesso-prontuario` | [0163](0163-duna-para-orla-e-vale-aud001-registro-da-flag.md) | 🟢 Registro da saída de emergência implementado: flag decisiva grava autoria/papel/instante; acesso normal e 403 não gravam; falha do INSERT gera erro estruturado sem derrubar a leitura. **133 testes, 468 asserções, 0 falhas** no PostgreSQL 18. ⚠️ Cockroach ainda não executado | **orla** (revisar e definir gate Cockroach) · **vale** (revisão cruzada) |
