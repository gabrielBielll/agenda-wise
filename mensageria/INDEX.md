...
| `fase-1-front` | [0147](0147-duna-para-orla-e-vale-desconexao-por-psicologa.md) | 🔄 Desconexão agora é por psicóloga: alvo explícito, revogação/remoção e pausa limitadas à pessoa; as demais seguem ativas. 122 testes/425 asserções verdes no PostgreSQL | **vale** (revisar) · **orla** (acompanhar CI) |
