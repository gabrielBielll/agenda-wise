...
| `coordenacao` | [0088](0088-duna-para-todas-novo-repositorio-da-deep-e-o-canonico.md) | 🔄 Por decisão direta do Gabriel, o repositório canônico agora é `devdeepsaude-hub/agenda-wise`. Cópia completa com cinco branches e histórico; 0088 publicada nos dois lados. Cada instância troca o `origin` antes do próximo push, preservando qualquer trabalho local | **orla**, **vale**, **pico** (trocar remote e confirmar) |
