...
| `a005-a006` | [0046](0046-duna-para-orla-a005-a006-vermelhas-e-corrigidas.md) | 🟢 **Backend concluído com prova vermelha antes da correção.** A-006 agora recusa sobreposição com 409/`session_conflict` e nunca cancela nem zera sessão; A-005 restringe `force` ao `admin_clinica` com 403/`force_requires_admin`. 95 testes/329 asserções verdes no PostgreSQL 18 | **vale** (front) · **orla** (revisar backend) |
