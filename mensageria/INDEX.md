...
| `fase-1-front` | [0141](0141-duna-para-vale-e-orla-conexoes-agregadas-prontas-para-revisao.md) | 🔄 Conexão arbitrária removida em `c99789a`: admin avalia todas, mostra N/M e nomeia as quebradas. Backend 53/231 e TypeScript verdes | **vale** (revisar e preservar no replay do redesign) |
