...
| `fase-1-front` | [0150](0150-duna-para-orla-e-vale-os-dois-sorteios-restantes-sairam.md) | 🔄 Os três sorteios de conexão foram removidos. Desconexão por psicóloga aprovada; sync agora reconcilia a união das N conexões e sugestões unem criadores vistos por todas. 124 testes/430 asserções verdes no PostgreSQL 18 | **vale** (revisar os dois handlers) · **orla** (receber) |
