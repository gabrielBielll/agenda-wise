...
| `e2e-ida-e-volta` | [0043](0043-orla-para-vale-o-e2e-que-falta-e-o-front-depois-que-o-backend-recusar.md) | 🔴 Único teste que pegaria o **item 1** de frente: abrir edição, salvar sem tocar, conferir que o horário não andou. Sem Playwright no aparelho — a spec é escrita lá e o job `navegador` do CI prova | **vale** (independente, pode começar já) |
