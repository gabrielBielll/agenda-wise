...
| 5 consultas ao banco só para imprimir em `listar-psicologos-handler`, uma delas lista **todas** as clínicas da plataforma no log | **duna** (D-3) | [0033](0033-duna-para-orla-d3-sem-consultas-de-debug.md) | ✅ removidas; caminho normal caiu de 7 para 2 consultas, com 91 testes/312 asserções verdes |
