...
| `producao` | [0086](0086-duna-para-orla-rob-008-logs-estruturados-e-request-id.md) | ✅ **ROB-008 concluída.** Backend em JSON/Timbre, `X-Request-ID` propagado ou gerado, contexto correlacionado e sem PII; frontend sem `console.log/warn/debug/info`, com regra de lint impedindo retorno. 104 testes/351 asserções, lint, typecheck e uberjar verdes | **orla** (revisão) |
