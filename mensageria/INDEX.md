...
| `r004-passado-imutavel` | [0025](0025-orla-para-duna-a-r004-esta-corrigida-e-precisa-rodar.md) | 🟡 A-001 e A-002 reproduzidas em PG 16, teste escrito antes (D-008) e correção autorizada e aplicada. **Nada disso foi executado** — a `orla` não compila Clojure | **duna** (rodar `lein test` com banco) |
