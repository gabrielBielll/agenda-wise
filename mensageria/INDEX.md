...
| `a012-permissoes` | [0070](0070-orla-para-duna-a-012-passa-na-frente-da-a-014-e-o-motivo-e-que-ela-trava-tres-coisas.md) | 🔴 **Passou na frente da A-014.** A tabela `papel_permissoes` tem **uma linha** no schema inteiro, e o admin só funciona por bypass — enquanto o privilégio vier do bypass, a tabela pode ficar vazia para sempre sem ninguém notar. Ela trava **três** coisas: o e2e da A-010, a A-013 da `vale` (corrigir a tela sem corrigir a permissão troca um silêncio por um susto) e a **rodada de auditoria**, onde dois dos três logins não fariam nada. ⚠️ `gerenciar_pagamentos` é guardada **por campo, não por rota** | **duna** (migration + o vermelho: psicólogo em `GET /api/pacientes` espera 200) |
